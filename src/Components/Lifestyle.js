  ...
  return (
    ...
    <div className="grid grid-rows-2 grid-cols-3">
        ...
        <div className="col-start-2 col-span-1 items-center flex items-center justify-center">
            <p className="mt-10 mb-10 text-center font-serif text-5xl">Lifestyle</p>
        </div>
        ...
        <p className="text-sm hover:text-red-500 mt-5 mb-5 ml-5 font-semibold cursor-pointer">Food</p>
        <a className="text-sm hover:text-red-500 mt-5 mb-5 ml-5 font-semibold cursor-pointer">Travel</a>
        <a className="text-sm hover:text-red-500 mt-5 mb-5 ml-5 font-semibold cursor-pointer">Decor</a>
        <a className="text-sm hover:text-red-500 mt-5 mb-5 ml-5 font-semibold cursor-pointer">Relationships</a>
    </div>
    </div>
    </div>
    </>
